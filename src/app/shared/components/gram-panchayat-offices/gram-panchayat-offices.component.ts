...
@Component({
  selector: 'app-gram-panchayat-offices',
  templateUrl: './gram-panchayat-offices.component.html',
  styleUrls: ['./gram-panchayat-offices.component.scss']
})
export class GramPanchayatOfficesComponent implements OnInit, OnDestroy {
    ...
    this.subscriptionTwo = this.apiService.subscribeRtiData.subscribe(
      rtiData => {
        ...
        if (this.selectedRoute === rtiData) {
          this.apiService.postPersonalRtiMoreInfoService(this.selectedRoute, data)
            .subscribe(
              (resultID: any) => {
